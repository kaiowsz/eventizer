    ...
    async function onSubmit(values: z.infer<typeof eventFormSchema>) {
        ...
        if(type === "Update") {
            ...
            try {
                ...
                if(eventUpdated) {
                    form.reset();
                    router.push(`/events/${eventUpdated._id}`)
                }
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5">
                ...
                <FormField control={form.control} name="description" render={({field}) => (
                        <FormItem className="w-full">
                            <FormControl className="h-72">
                                <Textarea placeholder="Descripition" {...field} className="textarea rounded-2xl" />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}/>
            ...
            <div className="flex flex-col gap-5 md:flex-row">
                <FormField control={form.control} name="price" render={({field}) => (
                    ...
                    <FormControl>
                        <div className="flex-center h-[54px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2">
                            <Image src="/assets/icons/dollar.svg" width={24} height={24} alt="Dollar"/>
                            <p className="ml-3 whitespace-nowrap text-grey-500">End Date:</p>
